...
// важно снова подчеркнуть пренципиальное отличае от традиционной внутренней ОО-механики:
...
// в итоге после new Foo() мы получаем два объекта, связанных друх с другом
// никакой инициализации класса или копирования не происходит, 
// просто между ними устанавливается ссылка
