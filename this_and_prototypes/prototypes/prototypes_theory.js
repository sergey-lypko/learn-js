...
// в JavaScript нет такого понятия как класс (как в традиционных ОО-языках)
// есть только объекты
...
// важно понять, что если функцию называют конструктором, то это значит, 
// что она лишь вспомагательный элемент, инициализатор создания объекта
...
console.log(Foo.__prototype__.constructor); // Foo
