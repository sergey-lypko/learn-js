...
// фактически полиморфизм - это возможность объекта изменять свое поведение
// на основании того, как он используется
...
// таким образом super - это указатель класс, откуда буду копироваться методы и свойства
